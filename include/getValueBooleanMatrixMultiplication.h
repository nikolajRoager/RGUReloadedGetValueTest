...
#ifndef RGURELOADEDGETVALUE_GETVALUEBOOLEANMATRIXMULTIPLICATION_H
#define RGURELOADEDGETVALUE_GETVALUEBOOLEANMATRIXMULTIPLICATION_H
...
#endif //RGURELOADEDGETVALUE_GETVALUEBOOLEANMATRIXMULTIPLICATION_H